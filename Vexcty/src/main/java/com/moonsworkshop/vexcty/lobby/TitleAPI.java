...
import com.moonsworkshop.vexcty.lobby.misc.ReflectionHelper;
    ...
    public static void sendActionBar(Player player, String message) {
        if (Vexcty.isOneEightVersion()) {
            ...
            try {
                ...
                try {
                    Class<?> chatMessageTypeClass = Class.forName("net.minecraft.server." + Vexcty.getVersion() + ".ChatMessageType");
