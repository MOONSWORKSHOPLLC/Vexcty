package com.moonsworkshop.vexcty.lobby.cossversion;
...
public enum VMaterial {
    ...
    public short getSubId() {
        return Vexcty.isLegacyVersion() ? (short) subId : 0;
    }

    public ItemStack toItemStack(int amount) {
        return new ItemStack(this.getType(), amount, this.getSubId());
    }
    ...
    public boolean equals(ItemStack itemStack) {
        return itemStack.getType() == getType() && itemStack.getData().getData() == this.getSubId();
    }
