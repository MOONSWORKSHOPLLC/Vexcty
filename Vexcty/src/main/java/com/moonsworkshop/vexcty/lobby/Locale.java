...
public enum Locale {
    ...
    public String getMessage(Player player) {
        String message = Vexcty.cfgM.getString(path).replace("%prefix%", PREFIX.getDefaultMessage());
    ...
    public String getDefaultMessage() {
        return ChatColor.translateAlternateColorCodes('&', Vexcty.cfgM.getString(path));
    }
